...
function diagram(type) {
  ...
  if(type.includes('sequences') || type.includes('arithmetic')) return svg('A discrete sequence shown as ordered terms and separate graph points',`${arrow}<text x="65" y="70" class="big">a₁</text><text x="205" y="70" class="big">a₂</text><text x="345" y="70" class="big">a₃</text><text x="485" y="70" class="big">a₄</text><path d="M110 65H180M250 65H320M390 65H460" class="heavy" marker-end="url(#arrow)"/><path d="M55 275H755M85 295V115" class="axis"/><circle cx="190" cy="245" r="7"/><circle cx="330" cy="210" r="7"/><circle cx="470" cy="175" r="7"/><circle cx="610" cy="140" r="7"/><text x="525" y="250">separate inputs</text>`);
  if(type.includes('geometric')) return svg('A geometric sequence repeatedly multiplies by the same ratio',`${arrow}<rect x="45" y="105" width="120" height="90" class="shape"/><rect x="235" y="105" width="120" height="90" class="shape"/><rect x="425" y="105" width="120" height="90" class="shape"/><rect x="615" y="105" width="120" height="90" class="shape"/><path d="M165 150H220M355 150H410M545 150H600" class="heavy" marker-end="url(#arrow)"/><text x="82" y="160" class="big">a₁</text><text x="272" y="160" class="big">a₂</text><text x="462" y="160" class="big">a₃</text><text x="652" y="160" class="big">a₄</text><text x="175" y="125">× r</text><text x="365" y="125">× r</text><text x="555" y="125">× r</text>`);
  if(type.includes('infinite-series')) return svg('Partial sums approach a limit when the geometric ratio has absolute value below one',`${arrow}<path d="M65 245H745M95 275V40" class="axis"/><path d="M110 225L235 155L355 120L475 102L595 93L715 89" class="curve"/><path d="M85 82H745" class="thin" stroke-dasharray="8 8"/><circle cx="110" cy="225" r="6"/><circle cx="235" cy="155" r="6"/><circle cx="355" cy="120" r="6"/><circle cx="475" cy="102" r="6"/><text x="570" y="68">sum approaches a limit</text><text x="155" y="275">more terms</text>`);
  if(type.includes('radian')) return svg('An angle in standard position measured by arc length on a circle',`${arrow}<circle cx="400" cy="165" r="120" class="shape"/><path d="M400 165H665M400 165L535 55" class="heavy"/><path d="M480 165A80 80 0 0 0 462 114" class="curve" marker-end="url(#arrow)"/><circle cx="400" cy="165" r="5"/><text x="485" y="135" class="big">θ</text><text x="555" y="95">arc length s</text><text x="510" y="190">radius r</text>`);
  if(type.includes('unit-circle')) return svg('A point on the unit circle forms a right triangle with coordinates cosine and sine',`<circle cx="400" cy="160" r="125" class="shape"/><path d="M70 160H730M400 300V20" class="axis"/><path d="M400 160L495 79L495 160Z" class="heavy"/><circle cx="495" cy="79" r="7"/><path d="M455 160A55 55 0 0 0 442 124" class="thin"/><text x="448" y="145">θ</text><text x="432" y="185">cos θ</text><text x="510" y="125">sin θ</text><text x="510" y="65">(cos θ, sin θ)</text>`);
  if(type.includes('sine-cosine')) return svg('Sine and cosine repeat around a midline with measurable amplitude and period',`<path d="M55 160H755M90 285V35" class="axis"/><path d="M80 160C130 70 180 70 230 160S330 250 380 160S480 70 530 160S630 250 730 160" class="curve"/><path d="M55 95H755M55 225H755" class="thin" stroke-dasharray="7 7"/><text x="605" y="82">maximum</text><text x="610" y="245">minimum</text><text x="605" y="150">midline</text>`);
  if(type.includes('trig-graphs')) return svg('A trigonometric graph repeats between vertical asymptotes',`<path d="M55 160H755M400 295V25" class="axis"/><path d="M205 25V295M595 25V295" class="thin" stroke-dasharray="8 8"/><path d="M220 280C285 270 325 225 400 160S520 50 580 35" class="curve"/><text x="145" y="48">asymptote</text><text x="610" y="48">asymptote</text><text x="360" y="205">one period</text>`);
  if(type.includes('inverse-trig')) return svg('A restricted trigonometric function and its inverse reflect across y equals x',`<path d="M55 270H755M400 295V25" class="axis"/><path d="M95 275L705 35" class="thin" stroke-dasharray="8 8"/><path d="M210 245C300 190 360 135 475 75" class="curve"/><path d="M160 235C220 120 275 60 330 35" class="heavy"/><text x="520" y="80">restricted trig</text><text x="130" y="100">inverse</text><text x="450" y="225">y = x</text>`);
  if(type.includes('trig-identities')) return svg('Equivalent trigonometric expressions connect through a known identity',`${arrow}<rect x="45" y="85" width="270" height="150" class="shape"/><rect x="485" y="85" width="270" height="150" class="shape"/><path d="M315 160H470" class="heavy" marker-end="url(#arrow)"/><text x="95" y="145" class="big">original side</text><text x="545" y="145" class="big">rewritten side</text><text x="330" y="125">use an identity</text><text x="335" y="205">same value</text>`);
  if(type.includes('angle-identities')) return svg('Two known angles combine to make a new exact trigonometric value',`${arrow}<circle cx="175" cy="160" r="75" class="shape"/><circle cx="625" cy="160" r="75" class="shape"/><path d="M175 160L235 115M625 160L680 105" class="heavy"/><path d="M270 160H530" class="heavy" marker-end="url(#arrow)"/><text x="130" y="265">known angles A and B</text><text x="560" y="265">A ± B</text><text x="320" y="135">sum / difference</text><text x="330" y="195">double / half</text>`);
  if(type.includes('trig-equations')) return svg('A trigonometric equation has repeating angle solutions across cycles',`${arrow}<path d="M55 160H755M90 285V35" class="axis"/><path d="M80 160C130 70 180 70 230 160S330 250 380 160S480 70 530 160S630 250 730 160" class="curve"/><path d="M55 110H755" class="thin" stroke-dasharray="7 7"/><circle cx="154" cy="110" r="7"/><circle cx="456" cy="110" r="7"/><circle cx="606" cy="110" r="7"/><text x="570" y="95">repeat solutions</text><text x="95" y="145">target value</text>`);
  if(type.includes('circle-conics')) return svg('A circle is all points a fixed radius from a center',`<path d="M55 160H755M400 295V25" class="axis"/><circle cx="400" cy="160" r="105" class="shape"/><circle cx="400" cy="160" r="6"/><path d="M400 160L505 160" class="heavy"/><text x="410" y="145">center (h,k)</text><text x="445" y="190">radius r</text><text x="500" y="90">(x-h)²+(y-k)²=r²</text>`);
  if(type.includes('parabola-conics')) return svg('A parabola is set by its vertex, focus, directrix, and axis',`<path d="M55 270H755M400 295V25" class="axis"/><path d="M250 265Q400 35 550 265" class="curve"/><path d="M170 235H630" class="thin" stroke-dasharray="8 8"/><circle cx="400" cy="125" r="7"/><circle cx="400" cy="205" r="7"/><text x="420" y="125">focus</text><text x="420" y="210">vertex</text><text x="500" y="225">directrix</text>`);
  if(type.includes('ellipse')) return svg('An ellipse has two axes and two foci inside the oval',`<path d="M55 160H755M400 295V25" class="axis"/><ellipse cx="400" cy="160" rx="190" ry="95" class="shape"/><circle cx="315" cy="160" r="7"/><circle cx="485" cy="160" r="7"/><path d="M210 160H590M400 65V255" class="thin"/><text x="285" y="140">focus</text><text x="495" y="140">focus</text><text x="320" y="285">major and minor axes</text>`);
  if(type.includes('hyperbola')) return svg('A hyperbola has two branches and crossing asymptotes through its center',`<path d="M55 160H755M400 295V25" class="axis"/><path d="M190 35L610 285M190 285L610 35" class="thin" stroke-dasharray="8 8"/><path d="M180 70C260 78 305 115 330 160S260 242 180 250M620 70C540 78 495 115 470 160S540 242 620 250" class="curve"/><rect x="330" y="100" width="140" height="120" class="shape"/><text x="510" y="80">asymptotes</text><text x="335" y="245">center box</text>`);
  if(type.includes('complex')) return svg('A complex number plotted on the complex plane with modulus and argument',`${arrow}<path d="M70 170H745M390 290V35" class="axis"/><path d="M390 170L590 85" class="heavy" marker-end="url(#arrow)"/><path d="M590 85V170M390 170H590" class="thin" stroke-dasharray="7 7"/><path d="M455 170A65 65 0 0 0 450 145" class="curve" marker-end="url(#arrow)"/><circle cx="590" cy="85" r="7"/><g class="graph-tag"><rect x="598" y="68" width="82" height="20"/><text x="605" y="83">z = a + bi</text></g><g class="graph-tag"><rect x="505" y="175" width="68" height="20"/><text x="512" y="190">real a</text></g><g class="graph-tag"><rect x="598" y="122" width="104" height="20"/><text x="605" y="137">imaginary b</text></g><text x="664" y="188">real axis</text><text x="405" y="55">imaginary axis</text><text x="468" y="136">θ</text><text x="493" y="108">|z|</text>`);
  if(type.includes('vector')) return svg('Vectors shown with components, resultant, angle, and projection guides',`${arrow}<path d="M70 260H745M105 290V35" class="axis"/><path d="M105 260L335 110" class="heavy" marker-end="url(#arrow)"/><path d="M335 110L585 185" class="curve" marker-end="url(#arrow)"/><path d="M105 260L585 185" class="heavy" marker-end="url(#arrow)"/><path d="M335 110V260M105 260H335" class="thin" stroke-dasharray="7 7"/><path d="M265 155L485 222" class="thin" stroke-dasharray="7 7"/><g class="graph-tag"><rect x="170" y="184" width="86" height="20"/><text x="177" y="199">component</text></g><g class="graph-tag"><rect x="440" y="196" width="78" height="20"/><text x="447" y="211">resultant</text></g><g class="graph-tag"><rect x="342" y="105" width="62" height="20"/><text x="349" y="120">vector</text></g><text x="130" y="238">θ</text><text x="290" y="278">horizontal part</text><text x="348" y="190">vertical part</text>`);
  if(type.includes('polar') || type.includes('rectangular-to-polar')) return svg('A polar point shown by radius, angle, and rectangular components',`${arrow}<circle cx="390" cy="170" r="65" class="thin"/><circle cx="390" cy="170" r="125" class="thin"/><circle cx="390" cy="170" r="185" class="thin"/><path d="M70 170H745M390 290V35" class="axis"/><path d="M390 170L575 80" class="heavy" marker-end="url(#arrow)"/><path d="M575 80V170M390 170H575" class="thin" stroke-dasharray="7 7"/><path d="M455 170A65 65 0 0 0 448 142" class="curve" marker-end="url(#arrow)"/><circle cx="575" cy="80" r="7"/><g class="graph-tag"><rect x="584" y="63" width="78" height="20"/><text x="591" y="78">(r, θ)</text></g><g class="graph-tag"><rect x="476" y="175" width="104" height="20"/><text x="483" y="190">x = r cos θ</text></g><g class="graph-tag"><rect x="584" y="122" width="102" height="20"/><text x="591" y="137">y = r sin θ</text></g><text x="466" y="136">θ</text><text x="500" y="110">r</text><text x="650" y="188">polar axis</text>`);
